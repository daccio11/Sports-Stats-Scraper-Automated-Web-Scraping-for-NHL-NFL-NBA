...
# Scrapes NBA career scoring leaders from Wikipedia and returns a Pandas DataFrame.

    url = "https://en.wikipedia.org/wiki/List_of_NBA_career_scoring_leaders"  # Wikipedia page URL
